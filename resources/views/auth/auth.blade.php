                ...
                <div>
                    ...
                    <div class="mt-1">
                        <input id="login" name="login" type="text" required autocomplete="username"
                            class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 px-2 py-2 sm:text-sm @error('login') border-red-300 @enderror"
                            value="{{ old('login') }}">
                        @error('login')
