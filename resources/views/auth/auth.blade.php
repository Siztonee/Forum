...
<div class="min-h-[80vh] flex flex-col justify-center py-12 sm:px-6 lg:px-8">
    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div class="bg-gray-900 py-8 px-4 shadow-md sm:rounded-lg sm:px-10">
            <form class="space-y-6" action="{{ route('auth.store') }}" method="POST">
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <input id="login" name="login" type="text" required autocomplete="username"
                            class="block w-full rounded-md border-gray-600 bg-gray-800 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-gray-100 px-2 py-2 sm:text-sm @error('login') border-red-500 @enderror"
                            value="{{ old('login') }}">
                        @error('login')
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <input id="password" name="password" type="password" required
                            class="block w-full rounded-md border-gray-600 bg-gray-800 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-gray-100 px-2 py-2 sm:text-sm @error('password') border-red-500 @enderror">
                        @error('password')
                        <p class="mt-2 text-sm text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <input id="remember-me" name="remember" type="checkbox" class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-600 rounded bg-gray-800">
            ...
            <div class="mt-6">
                <div class="relative">
                    ...
                    <div class="relative flex justify-center text-sm">
                        <span class="bg-gray-900 px-2 text-gray-400">Или зарегистрируйтесь через</span>
                    </div>
                </div>

                <div class="mt-6 grid grid-cols-2 gap-3">
                    <a href="{{ route('auth.social', 'google') }}"
                        class="inline-flex w-full justify-center rounded-md border border-gray-600 bg-gray-800 py-2 px-4 text-sm font-medium text-gray-300 shadow-sm hover:bg-gray-700">
